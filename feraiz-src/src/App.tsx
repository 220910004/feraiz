            ...
            <div className="flex flex-col gap-8">
              ...
              <div className={`flex flex-col gap-6 lg:flex-row lg:justify-between ${isArabic ? 'lg:flex-row-reverse' : 'lg:items-end'}`}>
                <div className="max-w-3xl">
                  <h1 className="text-4xl md:text-5xl font-semibold tracking-tight text-stone-950">{t.heroTitle}</h1>
                  <p className="mt-3 text-base md:text-lg text-stone-600 leading-7">{t.heroSubtitle}</p>
                </div>

                <div className={`lg:self-end lg:pb-1 ${isArabic ? 'text-left lg:text-left' : 'text-right'}`}>
                  <p className="font-arabic text-3xl text-stone-400" dir="rtl">
                    عِلْمُ الْفَرَائِض
                  </p>
                        ...
                        <div
                          className={`w-11 h-11 rounded-2xl flex items-center justify-center text-sm font-semibold shadow-sm transition-all ${
                            step > progressStep.num
                              ...
                              : isActive
                                ? 'bg-stone-900 text-white ring-4 ring-stone-200 shadow-[0_12px_24px_rgba(28,25,23,0.18)]'
